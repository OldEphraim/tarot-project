  ...
  return (
    <div className={`modal-overlay ${fadeOut ? "fade-out" : ""}`}>
      <div className="modal-content">
        <button className="modal-close" onClick={() => setFadeOut(true)}>
          X
        </button>
        ...
        <div className="modal-header">
          ...
          <p className="art-style">
            {selectedCardData.imageUrl === undefined &&
              "You should have seen this card "}
            in{" "}
            {selectedCardData.theme === "Rider-Waite"
              ? "the classic Rider-Waite"
              : `an AI-generated ${selectedCardData.theme}`}{" "}
            style
            {selectedCardData.imageUrl === undefined &&
        ...
        <p className="art-style">
          You drew{" "}
          {selectedCardData.card.arcana === "Minor Arcana" ||
